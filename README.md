...
<div style="display: flex; justify-content: space-between;">
    <a href="https://github.com/justin-marian/double-pendulum/tree/main/demo/simulation.mp4" style="width: 49%; height: 98%;" >
        <img src="/images/three_double_pendulums.png" alt="VELOCITY_POSITION_CURVE" style="width: 100%; height: auto;">
    </a>
    <a href="https://github.com/justin-marian/double-pendulum/tree/main/demo/simulation.mp4" style="width: 49%; height: 98%;" >
        <img src="/images/runge_kutta_4ode.png" alt="RUNGE_KUTTA_4ODE" style="width: 100%; height: auto;">
    </a>
</div>
